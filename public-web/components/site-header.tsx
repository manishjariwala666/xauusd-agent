...
export function SiteHeader() {
  ...
  return (
    <header className="site-header">
      ...
      <div className="header-actions"><Link className="login-link" href="/login">Login</Link>{links.telegram && <a className="button button-gold button-small" href={links.telegram} rel="noreferrer" target="_blank"><Icon name="send" size={17} />Join Telegram</a>}</div>
