...
export default async function HomePage() {
  ...
  return <div className="home-page">
    <section className="home-hero">
      ...
      <div className="home-hero-copy"><div className="hero-live-badge"><span className="hero-live-dot" /> XAUUSD INTELLIGENCE <b>•</b> BUILT FOR 2026</div><span className="eyebrow"><span />Independent gold intelligence</span><h1>See the market.<br /><em>Know your levels.</em></h1><p>VenusRealm brings XAUUSD research, structured Gold Signals and AI-assisted market intelligence into one focused member experience.</p><div className="hero-meta"><span>◷ <b>Signal desk</b> starts 03:30 IST</span><span>◉ <b>Morning + Evening</b> sessions</span></div><div className="hero-actions"><Link className="button button-gold" href="/signals">Premium Signal Desk <Icon name="arrow" size={18} /></Link><Link className="button home-button-outline" href="/blog">Read latest research</Link></div><div className="home-hero-proof" aria-label="Research principles"><span><Icon name="shield" size={15} />Signal data protected</span><span><Icon name="brain" size={15} />AI-assisted, reviewed</span><span><Icon name="book" size={15} />Education, not advice</span></div></div>
    ...
    <section className="home-section membership-section" id="membership" aria-labelledby="membership-title">
      <div>
        <span className="eyebrow">Member access</span>
        <h2 id="membership-title">Public research first. Protected Gold Signals when you&apos;re ready.</h2>
        <p>Create your member account, verify access and then open the protected Gold Signal Desk. Live direction, entry, stop-loss and targets stay out of the public homepage.</p>
        <div className="hero-actions">
          <Link className="button button-gold" href="/signup">Create member account <Icon name="arrow" size={17} /></Link>
          <Link className="text-link" href="/login">Already a member? Sign in <Icon name="arrow" size={15} /></Link>
        </div>
      </div>
      <div className="membership-steps" aria-label="Member access steps">
        <span><b>01</b>Create account</span>
        <span><b>02</b>Verify your email</span>
        <span><b>03</b>Complete paid-access verification</span>
        <span><b>04</b>Open the protected Signal Desk</span>
      </div>
    </section>
